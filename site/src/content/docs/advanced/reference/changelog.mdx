---
title: Changelog
description: Mirror of CHANGELOG.md in the kryton repo.
---

import { Aside } from '@astrojs/starlight/components';

<Aside type="note" title="Source">
This page mirrors `CHANGELOG.md` in the [`azrtydxb/kryton`](https://github.com/azrtydxb/kryton/blob/master/CHANGELOG.md) repo. If anything here disagrees with that file, the file wins.
</Aside>
...
- See [`docs/CLI.md`](https://github.com/azrtydxb/kryton/blob/master/docs/CLI.md) for usage.
